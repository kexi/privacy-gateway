...
Development environment setup, the full pre-commit/CI gate list, and the
supply-chain policy (pnpm `minimumReleaseAge`, blocked postinstall scripts,
SHA-pinned actions, digest-pinned base images) live in
