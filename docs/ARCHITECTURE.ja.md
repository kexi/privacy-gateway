...
| --------------------------- | ----------------------------------------------- | ----------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `MAX_BODY_BYTES`（gateway） | 64 KiB                                          | 256 KiB                                   | Codex CLI のターンは 64 KiB をはるかに超える指示ブロックを運ぶ。コストはレート制限・デッドライン・GPU 1 インスタンス・キルスイッチで抑えられる。                                                                                                                                  |
| `SYNTHESIS_MAX_BODY_BYTES`  | `MAX_BODY_BYTES × 2 + 64 KiB`（192 KiB）        | 576 KiB                                   | Synthesis は 1 つのボディでマスク済みプロンプト**全体**と Core 回答**全体**を受け取る。Gateway 側から導出すべきで、コピーしてはならない。                                                                                                                                         |
